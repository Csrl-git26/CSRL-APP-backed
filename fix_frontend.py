...
center_path = '/Users/surya/Desktop/CSRL-APP-frontend/src/components/CenterOverallWeakTopics.jsx'
student_path = '/Users/surya/Desktop/CSRL-APP-frontend/src/components/StudentOverallWeakTopics.jsx'

center_content = """import { useState, useEffect } from 'react';
...
student_content = """import { useState, useEffect } from 'react';
import { Loader2 } from 'lucide-react';
...
with open(center_path, 'w') as f:
    f.write(center_content)
with open(student_path, 'w') as f:
    f.write(student_content)

print("Frontend files updated via python.")
