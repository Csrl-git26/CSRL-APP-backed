  ...
  return (
    <div style={{ background:bg, borderRadius:12, padding:'16px 18px', display:'flex',
      ...
      <div>
        ...
        <div style={{ fontSize:10, color:'#94a3b8', marginTop:2, whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' }}>{sub}</div>
      </div>
    </div>
  );
}"""
  ...
  return (
    <div style={{ background:bg, borderRadius:10, padding:'10px 14px', display:'flex',
      ...
      <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize:10, color:'#94a3b8', marginTop:1, whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' }}>{sub}</div>
      </div>
    </div>
  );
}"""
