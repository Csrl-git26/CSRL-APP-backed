...
const centerPath = '/Users/surya/Desktop/CSRL-APP-frontend/src/components/CenterOverallWeakTopics.jsx';
const studentPath = '/Users/surya/Desktop/CSRL-APP-frontend/src/components/StudentOverallWeakTopics.jsx';

const centerContent = `import { useState, useEffect } from 'react';
    ...
    <div className="card" style={{ marginTop: 20 }}>
      ...
      <div style={{ padding: 24, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 14 }}>
        {SUBJECTS.map((subject) => {
          ...
          const subData = data.subjectWise[subjectKey] || { strong: [], moderate: [], weak: [] };
          return (
            <WeakTopicCard
              key={subject}
              subject={subject}
...
const studentContent = `import { useState, useEffect } from 'react';
import { Loader2 } from 'lucide-react';
...
console.log('Frontend files updated via fs.');
